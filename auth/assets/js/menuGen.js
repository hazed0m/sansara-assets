 function toggle(name) {
    ...
    if($("#"+name).css('height') == "0px") $("#"+name).css('height',$("#"+name).css('max-height')); else $("#"+name).css('height','0px');;
}
function showAnimSettingMenu() {
    if($(".list_anims").css('height') == "0px") $(".list_anims").css('height',$('.list_anims').css('max-height')); else $(".list_anims").css('height','0px');;
}
 ...
 let menu = new Vue({
    ...
    data: {
        ...
        options: [
            { text: 'Паспорт', value: 'passShow' },
            { text: 'Вызов администрации', value: 'reportShow' },
            { text: 'Эмоции', value: 'animateShow' },
            { text: 'Навыки персонажа', value: 'passShow' },
            { text: 'Настройки аккаунта', value: 'settingsShow'},
            { text: 'Настройка быстрых эмоций', value: 'settingsAnimShow'},
        ],
        animations: [
    ...
    methods: {
        ...
        animate: function(dict, name) {
            mp.trigger("animate.client", dict, name);
        },
        setFastAnim: function (id) {
