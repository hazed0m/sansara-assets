...
// male
[
{ID: 0, Name: "Отсутcтвуют", Collection: "mpbeach_overlays", Overlay: "FM_Hair_Fuzz"},
...
// blemishes
["Отсутcтвуют", "Корь", "Цыпки", "Крапинки", "Заражение", "Угревая сыпь", "Наращивание", "Пустулы", "Прыщи", "Лицо в угре", "Угорь", "Сыпь На Щеках", "Сыпь На Лице", "Сборщик", "Половое созревание", "Бельмо на глазу", "Сыпь На Подбородке ", "Две Грани", "Интимная зона", "Жирный", "Отмеченный", "Прыщи", "Прыщи повсюду", "Герпес", "Импетиго"],
// facial hair
["Отсутcтвуют", "Легкая Небритость", "Бальбо", "Круговая Борода", "Эспаньолка", "Подбородок", "Пуховый Подбородок", "Ремешок для подбородка", "Неряшливая", "Мушкетер", "Усы", "Подстриженная Борода", "Щетина", "Борода Тонкого Круга", "Подкова", "Карандаш и отбивные", "Подбородочная борода", "Бальбо и бакенбарды", "Баранья отбивная", "Неряшливая 2", "Кудрявая", "Кудрявая", "Колесо", "Фантастическая", "Отто", "Отто и незнакомец", "Свет Франца", "Хэмпстед", "Эмброуз", "Линкольнский Занавес"],
// eyebrows
["Отсутcтвуют", "Сбалансированные", "Модные", "Клеопатра", "Насмешливые", "Женские", "Соблазнительные", "Сжатые", "Чола", "Триумфальные", "Беззаботные", "Пышные", "Грызун", "Двойные", "Тонкие", "Карандаш", "Мать Плюккерово", "Прямые и узкие", "Натуральные", "Размытые", "Неопрятные", "Гусеница", "Обычные", "Средиземные", "Холеные", "Бушели", "Крылатые", "Колючие", "Монобровь", "Крылатые 2", "Тройные", "Арочные", "Контур", "Исчезающие", "Одинокие"],
// ageing
["Отсутcтвуют", "Гусиные лапки", "Первые Признаки", "Средний возраст", "Линии Беспокойства", "Депрессия", "Выдающийся", "Престарелый", "Потрепанный", "Морщинистый", "Отвисший", "Трудная жизнь", "Старинный", "Пенсионер", "Наркоман", "Гериатрический"],
// makeup
["Отсутcтвуют", "Дымчато-Черный", "Бронза", "Мягкий Серый", "Ретро Глэм", "Естественный вид", "кошачий глаз", "Чола", "Вампир", "Голливудское очарование", "Жевательная резинка", "Водяная мечта", "Подколки", "Пурпурная страсть", "Дымчатый кошачий глаз", "Тлеющий рубин", "Поп-принцесса"],
// blush
["Отсутcтвуют", "Полный", "Под углом", "Круглый", "Горизонтальный", "Высокий", "Возлюбленный", "Восьмидесятые"],
// complexion
["Отсутcтвуют", "Румяные Щеки", "Стерневая Сыпь", "Приливы", "Загар", "Избитый", "Алкоголик", "Неоднородный", "Тотем", "Сосуды", "Раненый", "Бледный", "Призрачный"],
// sun damage
["Отсутcтвуют", "Неравномерный", "Наждачная бумага", "Неоднородный", "Грубый", "Кожистый", "Текстурированный", "Грубый 2", "Неровный", "Мятый", "Потрескавшийся", "Песчаный"],
// lipstick
["Отсутcтвуют", "Матовые", "Лоск", "Матовый 2", "Глянецевые", "Тяжелый матовый", "Тяжелый лоск", "Матовый 3", "Лоск 3", "Размазанные", "Гейша"],
// freckles
["Отсутcтвуют", "Ангелоподобный", "Повсюду", "Неравномерный", "Точки", "Мост", "Куколка", "Эльф", "Поцелуй солнца", "Веснушки красотки", "Созвездие", "Модные", "Произво", "Крапчатый", "Капли дождя", "Двойное погружение", "Односторонний", "Парочка", "Рост"],
// chest hair
["Отсутcтвуют", "Естественные", "Полоска", "Дерево", "Волосатый", "Ужасный", "Обезьяна", "Ухоженная обезьяна", "Бикини", "Удар молнии", "Обратная Молния", "Сердце Любви", "Грудь", "Счастливое лицо", "Череп", "Улиточный След", "Слизняк и щипки", "Волосатые руки"]
];
