...
let autosList = [
	...
	motosList = [
		...
		{ name: 'faggio2', hash: '0x350D1AB', speed:160, luggage: 10, type: 'скутер',price: 1002, info: 'Faggio - это скутер/мотороллер, производимый на свет белый реально несуществующей итальянской компанией Principe, отвечающей за производство мотоциклов в серии Grand Theft Auto, пародирующей реальные итальянские бренды, такие как Ducati и Piaggio.', places: 2},
		{ name: 'faggio3', hash: '0xB328B188', speed:113 , luggage: 10, type: 'скутер',price: 1003, info: 'Faggio Mod - это скутер, за производство которого отвечает выдуманная, несуществующая в реальном мире компания Pegassi, являющиеся пародией на других итальянских производителей Ducati и Piaggio.', places: 2},
		{ name: 'akuma', hash: '0x63ABADE7', speed:180 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Akuma (от японского "дьявол") - это высокоскоростной мотоцикл типа "стритфайтер", производимый внутриигровой, несуществующей в реальном мире, японской компанией Dinka, основанная на другой, реальной японской компании Honda. ', places: 2},
        { name: 'bagger', hash: '0x806B9CC3', speed:150 , luggage: 20, type: 'туристический',price: 1001, info: 'Bagger - это гражданский туристический мотоцикл, спроектированный инженерами и собираемый рабочими выдуманной, несуществующей в реальном мире внутриигровой американской мотоциклетной фирмы Western Motorcycle Company, являющейся пародией на известную Harley Davidson.', places: 2},
        { name: 'carbonrs', hash: '0xABB0C0', speed:180 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Carbon RS - это гражданский спортивный мотоцикл, за чьё производство отвечает выдуманная, несуществующая в реальном мире внутриигровая японская компания Nagasaki, чьим прототипом является другая реально существующая японская компания Kawasaki.', places: 2},
        { name: 'daemon', hash: '0x77934CEE', speed:160 , luggage: 15, type: 'чоппер',price: 1001, info: 'Daemon - это гражданский мотоцикл с типом корпуса "чоппер", за чьё производство отвечает придуманная Rockstar, несуществующая в реальности внутриигровая американская компания Western Motorcycle Company, являющаяся пародией на существующую американскую компанию Harley Davidson. ', places: 2},
        { name: 'innovation', hash: '0xF683EACA', speed:170 , luggage: 5, type: 'чоппер',price: 1001, info: 'Innovation - это мотоцикл с типом корпуса "чоппер", производимый на свет придуманной внутриигровой американской компанией Liberty City Cycles, пародирующая такие известные американские мотостроительные компании, как Harley Davidson, West Coast Choppers, Orange County Choppers.', places: 2},
        { name: 'diablous', hash: '0xF1B44F44', speed:180 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Мощный и быстрый мотоцикл для игры, доступный в GTA 5 и GTA Online. Вам следует быть осторожным, приглашая Principe Diabolus в вашу жизнь. Этот монстр может круто её изменить и переделать. Он достаточно крут, чтобы после небольших модернизаций в мастерской претендовать на роль спортивного мотоцикла для уличных гонок.', places: 2},
        { name: 'double', hash: '0x9C669788', speed:180 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Double-T - это спортивный мотоцикл, спроектированный и производимый несуществующей в реальном мире, выдуманной внутриигровой японской компанией Dinka, пародирующей такую реально существующую японскую фирму, как Honda.', places: 2},
        { name: 'enduro', hash: '0x6882FA73', speed:170 , luggage: 5, type: 'кроссовый',price: 1001, info: 'Enduro - это внедорожный винтажный мотоцикл, производимый на свет выдуманной, внутриигровой японской компанией Dinka, созданной Rockstar с оглядкой на реально существующую японскую компанию Honda.', places: 2},
        { name: 'hakuchou2', hash: '0xF0C2A91F', speed:200 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Hakuchou Drag является модифицированной версией Hakuchou, отличающийся, кроме характеристик, раскраской, похожее на лаковое покрытие. Как и его предшественник, дизайн мотоцикла основан на Suzuki GSX1300R Hayabusa. Модификация включает в себя другую раму, зеркала, сделанные на заказ хромированные колеса и растянутый свингарм.', places: 2},
        { name: 'nemesis', hash: '0xDA288376', speed:170 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Nemesis - это мотоцикл двойного назначения (т.е. предназначенный для передвижения как по асфальтовым дорогам, так и по пересечённой местности), спроектированный и производимый несуществующей в реальном мире внутриигровой итальянской мотостроительной компанией Principe, основанной Rockstar на других итальянских мотоциклетных компаниях - на Ducati и Piaggio.', places: 2},
        { name: 'nightblade', hash: '0xA0438767', speed:170 , luggage: 10, type: 'чоппер',price: 1001, info: 'Nightblade - мотоцикл, добавленный в GTA Online как часть обновления "Байкеры", разработанный и выпускаемый вымышленной компанией The Western Motorcycle Company, пародирующая американскую компанию Harley Davidson.', places: 2},
        { name: 'ratbike', hash: '0x6FACDF31', speed:150 , luggage: 15, type: 'чоппер',price: 1001, info: 'The Western Rat Bike - это новое и, наверное, самое нестандартное транспортное средство от компании Western Motorcycle Company. Этот мотоцикл был добавлен в Grand Theft Auto Online после обновления Байкеры.', places: 2},
        { name: 'ruffian', hash: '0xCABD11E8', speed:200 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Ruffian - это гражданский повседневный мотоцикл, производимый, хоть и известной, но несуществующей в реальном мире внутриигровой итальянской компанией Pegassi, основанной на таких реально существующих мастодонтах, как Lamborghini и Pagani, а также производитель мотоциклов (о коих далее и пойдёт речь) Ducati.', places: 2},
        { name: 'vortex', hash: '0xDBA9DBFC', speed:180 , luggage: 5, type: 'спортбайк',price: 1001, info: 'Vortex - это мотоцикл, созданный вымышленной компанией Pegassi, пародирующая Ducati и Piaggio. Он является представителем класса "стритфайтер". Эти байки отличаются от других спортивных мотоциклов тем, что в конструкции не используются пластиковые детали.', places: 2},
        { name: 'zombiea', hash: '0xC3D7C72B', speed:170 , luggage: 10, type: 'чоппер',price: 1001, info: 'The Western Motorcycle Company Zombie Bobber - это мотоцикл, который является дополнительным вариантом Zombie Chopper. Стал доступен с выходом обновления "Байкеры" в Grand Theft Auto Online.', places: 2}
	],
	trucksList = [
		{ name: 'benson', hash: '0x7A61B330', speed: 140, luggage: 1500, type: 'грузовик',price: 1006, info: 'Benson, это типичный грузовик, используемый для перевозки грузов по автомобильным магистралям. Он обладает мощным двигателем, способным разогнать этого гиганта, весом семь тонн, до скорости 209 км/ч. Машина набирает скорость от нуля до 100 км/ч за 14.2 секунды, что является не лучшим показателем в классе.', places: 2},
		{ name: 'hauler', hash: '0x5A82F9AE', speed: 115, luggage: 0, type: 'тягач',price: 1006, info: 'Не смотря на внешний вид и предназначение этого грузовика, двигатель Hauler не такой мощный как можно было бы ожидать. Дизельный FR Inline 6, разгоняет Hauler до максимальной скорости в 185 км/ч, при этом первые 100 км/ч грузовик набирает за 9 секунд.', places: 2},
		{ name: 'mule', hash: '0x35ED670B', speed: 110, luggage: 1000, type: 'грузовик',price: 1006, info: 'В GTA 5, Mule обладает куда большей прочностью и чуть лучшими ходовыми характеристиками. Его максимальная скорость составляет 161 км/ч, с динамикой разгона от нуля до 100 км/ч за 10.3 секунды.', places: 2},
		{ name: 'packer', hash: '0x21EEE87D', speed: 130, luggage: 0, type: 'тягач',price: 1001, info: 'В GTA 5 MTL Packer гораздо более быстрый и немного более маневренный, чем его предшественники из предыдущих игр серии. У него под капотом находится 6-ти цилиндровый 24-х клапанный турбированный дизельный двигатель F4 Inline 6, дающий тягачу не плохой, для такого класса техники, максимальную скорость - 193 км/ч.', places: 2},
		{ name: 'phantom', hash: '0x809AA4CB', speed: 123, luggage: 0, type: 'тягач',price: 1002, info: 'Этот классический тягач, используемый, в основном, дальнобойщиками, оснащен достаточной мощным дизельным двигателем F4 Supercharged Inline 6, дающим ему вполне хорошую максимальную скорость в 198 км/ч и динамику разгона - с нуля до 100 км/ч за 8.6 секунды.', places: 2},
		{ name: 'pounder2', hash: '0x6290F15B', speed: 135, luggage: 2000, type: 'грузовик',price: 1003, info: 'Огромные габариты и вес, делают этот грузовик весьма неповоротливым, однако, что касается скорости и ускорения  - тут характеристики весьма впечатляющие, для грузовика такой массы. Двигатель разгоняет Pounder до максимальной скорости в 193 км/ч, что, учитывая пяти тонную массу грузовика, делает его отличным средством, чтобы избавиться от пары надоедливых противников на дороге.', places: 2},
		{ name: 'terbyte', hash: '0x897AFC65', speed: 117, luggage: 3000, type: 'грузовик',price: 1004, info: 'Этот громоздкий мощный автомобиль с цельнометаллическим кузовом скрывает в себе множество сюрпризов. Вам может показаться со стороны, что это простой грузовик, однако приглядевшись получше вы поймете, что перед вами настоящий центр мобильных операций. Характеристика Benefactor Terrorbyte просто поражает.', places: 2},
		{ name: 'docktrailer', hash: '0x806EFBEE', speed: 0, luggage: 4000, type: 'грузовик',price: 1006, info: 'Dock Trailer – буксируемый полуприцеп, доступный в GTA V и GTA Online. Данная модель имеет двухосное шасси, способное удерживать контейнеры. Dock Trailer можно перекрашивать; выглядит полуприцеп, так скажем, немного потрепанным, а также он значительно длиннее, чем прочие транспортные средства его вида.', places: 0},
		{ name: 'trailers2', hash: '0xA1DA3C91', speed: 0, luggage: 5000, type: 'тягач',price: 1006, info: 'Trailer S без дополнительной цифры, присоединенной к названию, открывает небольшую линейку стандартных полуприцепов – таких друг на друга похожих, но, тем не менее, в чем-то разных. Trailer S – тентованная модель, контейнер которой завешан синим и держится на четырех колесах. Задние двери не открываются, а служат своего рода декорацией. Неправда ли, нельзя выглядеть стандартнее?', places: 0},
		{ name: 'tvtrailer', hash: '0x967620BE', speed: 0, luggage: 6000, type: 'грузовик',price: 1006, info: 'Модель TV Trailer ничем не отличается от стандартного полуприцепа, разве что пестрой раскраской своего контейнера, на котором в яркой вспышке фейерверка изображен логотип вымышленного внутриигрового телешоу «Flame or Shame» («Слава или позор»).', places: 0}
	],
	boatsList = [
